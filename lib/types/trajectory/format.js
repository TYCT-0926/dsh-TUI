...
export function statusColor(node) {
...
export function ledgerLayout(columns) {
    ...
    if (columns >= 110)
        return { badge: 4, index: true, outcome: true, detail: Math.max(12, columns - 68) };
    if (columns >= 90)
        return { badge: 4, index: true, outcome: true, detail: Math.max(12, columns - 60) };
    if (columns >= 70)
        return { badge: 4, index: false, outcome: false, detail: Math.max(12, columns - 22) };
